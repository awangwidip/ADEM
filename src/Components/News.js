...
export default function News () {
	return (
		<div className='News_News'>
			...
			<div className='Group'>
				<img className='Vector' src = {ImgAsset.News_Vector} />
				<img className='Vector_1' src = {ImgAsset.News_Vector_1} />
			</div>
			<span className='News_1'>News</span>
			...
			<Link to='/chatbot'>
				<div className='Group1447'>
					...
					<div className='Group_1'>
						<img className='Vector_2' src = {ImgAsset.News_Vector_2} />
						<img className='Vector_3' src = {ImgAsset.News_Vector_3} />
					</div>
					<img className='Vector89' src = {ImgAsset.News_Vector89} />
				</div>
			</Link>
		</div>
	)
