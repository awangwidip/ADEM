...
export default function Internship () {
	return (
		<div className='Internship_Internship'>
			...
			<div className='Group'>
				<img className='Vector' src = {ImgAsset.Internship_Vector} />
				<img className='Vector_1' src = {ImgAsset.Internship_Vector_1} />
			</div>
			<span className='InternshipOffer'>Internship Offer</span>
			...
			<Link to='/chatbot'>
				<div className='Group1447'>
					...
					<div className='Group_1'>
						<img className='Vector_2' src = {ImgAsset.Internship_Vector_2} />
						<img className='Vector_3' src = {ImgAsset.Internship_Vector_3} />
					</div>
					<img className='Vector89' src = {ImgAsset.Internship_Vector89} />
				</div>
			</Link>
		</div>
	)
