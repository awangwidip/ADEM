...
export default function Scholarship () {
	return (
		<div className='Scholarship_Scholarship'>
			...
			<div className='Group'>
				<img className='Vector' src = {ImgAsset.Scholarship_Vector} />
				<img className='Vector_1' src = {ImgAsset.Scholarship_Vector_1} />
			</div>
			<span className='CompetitionandScholarship'>Competition and Scholarship   </span>
			...
			<Link to='/chatbot'>
				<div className='Group1447'>
					...
					<div className='Group_1'>
						<img className='Vector_2' src = {ImgAsset.Scholarship_Vector_2} />
						<img className='Vector_3' src = {ImgAsset.Scholarship_Vector_3} />
					</div>
					<img className='Vector89' src = {ImgAsset.Scholarship_Vector89} />
				</div>
			</Link>
		</div>
	)
